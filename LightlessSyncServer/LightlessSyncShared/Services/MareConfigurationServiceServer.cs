...
public sealed class LightlessConfigurationServiceServer<T> : IDisposable, IConfigurationService<T> where T : class, ILightlessConfiguration
{
    ...
    public LightlessConfigurationServiceServer(IOptionsMonitor<T> config)
    {
        _config = config;
